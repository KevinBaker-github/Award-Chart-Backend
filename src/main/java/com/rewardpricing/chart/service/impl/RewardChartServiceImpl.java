...
import com.rewardpricing.chart.mapper.RewardChartResponseMapper;
...
public class RewardChartServiceImpl implements RewardChartService {
  ...
  public List<ResponseRewardChart> listAll() {
    ...
    List<ResponseRewardChart> reponse =
        RewardChartResponseMapper.buildAwardChartResponse(entitiesList);
  ...
  public ResponseEntity<RewardPricingEntity> addCategory(RewardPricingEntity request) {
    ...
    Optional<RewardPricingEntity> existingEntity =
